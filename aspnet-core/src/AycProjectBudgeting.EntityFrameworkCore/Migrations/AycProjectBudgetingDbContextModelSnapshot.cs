...
{
    [DbContext(typeof(AycProjectBudgetingDbContext))]
    partial class AycProjectBudgetingDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AycProjectBudgeting.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("AycProjectBudgeting.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AycProjectBudgeting.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AycProjectBudgeting.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AycProjectBudgeting.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AycProjectBudgeting.Authorization.Roles.Role", b =>
                {
                    b.HasOne("AycProjectBudgeting.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("AycProjectBudgeting.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("AycProjectBudgeting.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
